        ...
        return(
            <div>
                <form>
                    ...
                    <input type="text" placeholder="Escríbenos tu Email" ref={input => {this.textemail = input;}}></input>
                    ...
                    ref={input => {this.textComunidadLider = input;}} readOnly></input>
                    ...
                    ref={input => {this.textComunidadParticipa = input;}} readOnly></input>
                    <textarea placeholder="Quieres saludarnos? Escríbenos aquí..." ref={input => {this.saludo = input;}}></textarea>
                    <button onClick={this.addContact}>ENVIAR!</button>
                </form>
            </div>
        );
    }
